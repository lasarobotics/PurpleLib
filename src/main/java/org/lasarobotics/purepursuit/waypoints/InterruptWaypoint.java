...
import org.lasarobotics.purepursuit.actions.InterruptAction;
...
public class InterruptWaypoint extends PointTurnWaypoint {
  ...
  */
  public InterruptWaypoint(Translation2d translation,
                           Rotation2d rotation,
                           LinearVelocity movementSpeed,
                           AngularVelocity turnSpeed,
                           Distance followRadius,
                           Distance positionBuffer,
  ...
  * @param action         The action the robot performs at this point.
  */
  public InterruptWaypoint(Pose2d pose,
                           LinearVelocity movementSpeed,
                           AngularVelocity turnSpeed,
                           Distance followRadius,
                           Distance positionBuffer,
  ...
  */
  ...
  public Waypoint.Type getType() {
    return Waypoint.Type.INTERRUPT;
  }
