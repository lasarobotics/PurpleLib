...
public class TalonSRX extends LoggableHardware {
   ...
   * @see #configPeakCurrentLimit(int)
   * @see #configContinuousCurrentLimit(int)
   */
  ...
  public ErrorCode configPeakCurrentLimit(int amps) {
    return m_talon.configPeakCurrentLimit(amps);
  }
  ...
  public ErrorCode configContinuousCurrentLimit(int amps) {
    return m_talon.configContinuousCurrentLimit(amps);
  }
