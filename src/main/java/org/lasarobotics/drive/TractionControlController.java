...
public class TractionControlController {
  ...
  private final double PREDICTED_SLIP_RATIO_WEIGHT = 0.9;
  ...
  public Measure<Velocity<Distance>> calculate(Measure<Velocity<Distance>> velocityRequest,
    ...
    double weightedSlipRatio = predictedSlipRatio * (m_isSlipping ? PREDICTED_SLIP_RATIO_WEIGHT : 1.0) + (m_isSlipping ? (currentSlipRatio * (1 - PREDICTED_SLIP_RATIO_WEIGHT)) : 0.0);
